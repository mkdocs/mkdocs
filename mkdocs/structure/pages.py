...
class Page:
    ...
    def __eq__(self, other):
        return isinstance(other, self.__class__) and self.title == other.title and self.file == other.file
    ...
    def render(self, config, files):
        ...
        md = markdown.Markdown(extensions=extensions, extension_configs=config["mdx_configs"] or {})
