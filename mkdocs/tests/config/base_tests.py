...
class ConfigBaseTests(unittest.TestCase):
    ...
    def test_load_from_deleted_file(self):
        ...
        try:
            ...
            os.remove(config_file.name)
        self.assertRaises(exceptions.ConfigurationError, base.load_config, config_file=config_file)
    ...
    def test_load_missing_required(self):
        ...
        try:
            ...
            self.assertRaises(exceptions.Abort, base.load_config, config_file=config_file.name)
        finally:
            os.remove(config_file.name)
