...
class TypeTest(unittest.TestCase):
    ...
    def test_multiple_types(self):
        ...
        self.assertRaises(config_options.ValidationError, option.validate, {"a": 1})
    ...
    def test_length(self):
        ...
        self.assertRaises(config_options.ValidationError, option.validate, "Testing Long")
...
class ChoiceTest(unittest.TestCase):
    ...
    def test_invalid_choice(self):
        option = config_options.Choice(("python", "node"))
        self.assertRaises(config_options.ValidationError, option.validate, "go")
...
class IpAddressTest(unittest.TestCase):
    ...
    def test_invalid_address_range(self):
        option = config_options.IpAddress()
        self.assertRaises(config_options.ValidationError, option.validate, "277.0.0.1:8000")

    def test_invalid_address_format(self):
        option = config_options.IpAddress()
        self.assertRaises(config_options.ValidationError, option.validate, "127.0.0.18000")
    ...
    def test_invalid_address_port(self):
        option = config_options.IpAddress()
        self.assertRaises(config_options.ValidationError, option.validate, "127.0.0.1:foo")

    def test_invalid_address_missing_port(self):
        option = config_options.IpAddress()
        self.assertRaises(config_options.ValidationError, option.validate, "127.0.0.1")
    ...
    def test_invalid_IPv6_address(self):
        ...
        option = config_options.IpAddress()
        self.assertRaises(config_options.ValidationError, option.validate, "[::1]:8000")
...
class URLTest(unittest.TestCase):
    ...
    def test_invalid_url(self):
        ...
        option = config_options.URL()
        self.assertRaises(config_options.ValidationError, option.validate, "www.mkdocs.org")

    def test_invalid(self):

        option = config_options.URL()
        self.assertRaises(config_options.ValidationError, option.validate, 1)
...
class DirTest(unittest.TestCase):
    ...
    def test_dir_filesystemencoding(self):
        ...
        test_config = {"dir": "Übersicht".encode(encoding=sys.getfilesystemencoding())}
...
class SiteDirTest(unittest.TestCase):
    ...
    def test_doc_dir_in_site_dir(self):
        ...
        for test_config in test_configs:
            self.assertRaises(config_options.ValidationError, self.validate_config, test_config)
...
class ThemeTest(unittest.TestCase):
    ...
    def test_uninstalled_theme_as_string(self):
        ...
        option = config_options.Theme()
        self.assertRaises(config_options.ValidationError, option.validate, "mkdocs2")
    ...
    def test_theme_config_missing_name(self):
        ...
        option = config_options.Theme()
        self.assertRaises(config_options.ValidationError, option.validate, config)
    ...
    def test_post_validation_none_theme_name_and_missing_custom_dir(self):
        ...
        option = config_options.Theme()
        self.assertRaises(config_options.ValidationError, option.post_validation, config, "theme")
...
class PrivateTest(unittest.TestCase):
    def test_defined(self):
        ...
        self.assertRaises(config_options.ValidationError, option.validate, "somevalue")
...
class MarkdownExtensionsTest(unittest.TestCase):
    ...
    def test_simple_list(self, mockMd):
        ...
        self.assertEqual({"markdown_extensions": ["foo", "bar"], "mdx_configs": {}}, config)
        ...
        self.assertEqual(
            {
                ...
                "mdx_configs": {"bar": {"bar_option": "bar value"}},
            },
            config,
        )
    ...
    def test_builtins(self, mockMd):
        ...
        option.post_validation(config, "markdown_extensions")
        self.assertEqual(
            {"markdown_extensions": ["meta", "toc", "foo", "bar"], "mdx_configs": {}},
            config,
        )
    ...
    def test_duplicates(self):
        ...
        config["markdown_extensions"] = option.validate(config["markdown_extensions"])
        option.post_validation(config, "markdown_extensions")
        self.assertEqual({"markdown_extensions": ["meta", "toc"], "mdx_configs": {}}, config)
    ...
    def test_none(self):
        ...
        config["markdown_extensions"] = option.validate(config["markdown_extensions"])
        option.post_validation(config, "markdown_extensions")
        self.assertEqual({"markdown_extensions": [], "mdx_configs": {}}, config)

    @patch("markdown.Markdown")
    def test_not_list(self, mockMd):
        option = config_options.MarkdownExtensions()
        self.assertRaises(config_options.ValidationError, option.validate, "not a list")
