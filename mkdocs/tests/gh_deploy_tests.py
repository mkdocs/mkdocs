...
class TestGitHubDeploy(unittest.TestCase):
    ...
    def test_deploy_no_cname(self, mock_isfile, mock_import, check_version, get_remote, get_sha, is_repo):
    ...
    def test_deploy_error(self, mock_log, mock_import, check_version, get_sha, is_repo):
        ...
        mock_log.error.assert_called_once_with(f"Failed to deploy to GitHub with error: \n{error_string}")
