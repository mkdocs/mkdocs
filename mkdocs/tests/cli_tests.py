...
class CLITests(unittest.TestCase):
    ...
    def test_serve_config_file(self, mock_serve):
        ...
        result = self.runner.invoke(cli.cli, ["serve", "--config-file", "mkdocs.yml"], catch_exceptions=False)
    ...
    def test_serve_dev_addr(self, mock_serve):
        ...
        result = self.runner.invoke(cli.cli, ["serve", "--dev-addr", "0.0.0.0:80"], catch_exceptions=False)
    ...
    def test_serve_theme(self, mock_serve):
        ...
        result = self.runner.invoke(cli.cli, ["serve", "--theme", "readthedocs"], catch_exceptions=False)
    ...
    def test_serve_use_directory_urls(self, mock_serve):
        ...
        result = self.runner.invoke(cli.cli, ["serve", "--use-directory-urls"], catch_exceptions=False)
    ...
    def test_serve_no_directory_urls(self, mock_serve):
        ...
        result = self.runner.invoke(cli.cli, ["serve", "--no-directory-urls"], catch_exceptions=False)
    ...
    def test_build_config_file(self, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["build", "--config-file", "mkdocs.yml"], catch_exceptions=False)
    ...
    def test_build_theme(self, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["build", "--theme", "readthedocs"], catch_exceptions=False)
    ...
    def test_build_use_directory_urls(self, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["build", "--use-directory-urls"], catch_exceptions=False)
    ...
    def test_build_no_directory_urls(self, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["build", "--no-directory-urls"], catch_exceptions=False)
    ...
    def test_build_site_dir(self, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["build", "--site-dir", "custom"], catch_exceptions=False)
    ...
    def test_gh_deploy_remote_branch(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--remote-branch", "foo"], catch_exceptions=False)
    ...
    def test_gh_deploy_remote_name(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--remote-name", "foo"], catch_exceptions=False)
    ...
    def test_gh_deploy_ignore_version(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--ignore-version"], catch_exceptions=False)
    ...
    def test_gh_deploy_theme(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--theme", "readthedocs"], catch_exceptions=False)
    ...
    def test_gh_deploy_use_directory_urls(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--use-directory-urls"], catch_exceptions=False)
    ...
    def test_gh_deploy_no_directory_urls(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--no-directory-urls"], catch_exceptions=False)
    ...
    def test_gh_deploy_site_dir(self, mock_gh_deploy, mock_build, mock_load_config):
        ...
        result = self.runner.invoke(cli.cli, ["gh-deploy", "--site-dir", "custom"], catch_exceptions=False)
