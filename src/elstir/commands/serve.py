...
from elstir.commands.build import build
from elstir.config import load_config
from elstir.exceptions import Abort
...
def _init_asyncio_patch():
    ...
    As Tornado has decided to leave this to users to set, elstir needs
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the elstir development server
    ...
    # string is returned. And it makes elstir temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='elstir_')
