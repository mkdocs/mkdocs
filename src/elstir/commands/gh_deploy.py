...
default_message = """Deployed {sha} with elstir version: {version}"""
...
def gh_deploy(config, message=None, force=False, ignore_version=False):
    ...
    message = message.format(version=elstir.__version__, sha=sha)
