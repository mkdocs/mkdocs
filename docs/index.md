...
If you are on Windows, and the `mkdocs` command is not working, you may need to add the Python Scripts folder to your `PATH` Environment variable.
...
If you installed Python from their Windows installer:
```
