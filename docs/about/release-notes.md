...
*   The package (wheel and source) is now produced by Hatch build system and pyproject.toml instead of setup.py (#2988)

*   Translation sub-commands of `setup.py` were completely dropped. See documentation for their new replacements (#2990)
